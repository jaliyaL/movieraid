...
<div class="widget contacts-widget">
	...
	<div class="widget-head br-green">
		<h3><i class="fa fa-user"></i> New Users</h3>
	</div>
		...
		<ul class="list-unstyled">
			...
			<li class="c-list">
				...
				<div class="contact-details">
					...
					<div class="pull-left">
						<strong>{{ $new_user->name }} | Score : {{ $new_user->score }}</strong>
						<small>Joined Date : {{ $new_user->created_at->todatestring() }}</small>
					</div>
	...
	<div class="widget-foot">
		...
		<a href="{{ url('/users') }}" class="btn btn-success btn-xs pull-right">User List</a>
		<div class="clearfix"></div>
	</div>

...
@section('title', 'Register | MovieRaid v1.0')

@section('content')
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading font150 text-center">Register</div>
